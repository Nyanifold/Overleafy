...
test("extracts project IDs from bare IDs and web URLs", () => {
    assert.equal(extractProjectId("0123456789ABCDEF01234567"), "0123456789abcdef01234567");
    assert.equal(extractProjectId("https://www.overleaf.com/project/0123456789abcdef01234567"), "0123456789abcdef01234567");
});
test("creates a credential-free default binding", () => {
    ...
    assert.equal(binding.gitUrl, "https://git.overleaf.com/0123456789abcdef01234567");
...
test("rejects credentials in explicit Git URL", () => {
    assert.throws(() => createProjectBinding({
        project: "0123456789abcdef01234567",
        localBranch: "main",
