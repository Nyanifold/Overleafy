...
export type ErrorCode = "AUTH_REQUIRED" | "SESSION_EXPIRED" | "GIT_INTEGRATION_UNAVAILABLE" | "REPO_NOT_FOUND" | "BINDING_INVALID" | "DIRTY_WORKTREE" | "PLAN_STALE" | "REMOTE_MOVED" | "REMOTE_REWRITTEN" | "CONFLICT" | "OPERATION_IN_PROGRESS" | "LOCKED" | "NETWORK" | "RATE_LIMITED" | "GIT_FAILED" | "INTERNAL";
...
export type GitOperation = "none" | "merge" | "rebase" | "cherry-pick" | "revert" | "bisect";
...
export type CommitRelationship = "equal" | "local_ahead" | "remote_ahead" | "diverged" | "local_unborn" | "remote_unborn" | "both_unborn";
...
export type SyncClassification = "equal_clean" | "equal_dirty" | "local_ahead" | "remote_ahead" | "diverged" | "remote_rewritten" | "operation_in_progress" | "unborn" | "invalid";
...
export type SyncAction = {
    ...
    type: "push";
    expectedRemoteOid: Oid | null;
} | {
    type: "reset_to_remote";
    oid: Oid;
} | {
...
export interface RepositoryPort {
    inspect(repositoryPath: string, binding: ProjectBinding | undefined, options: InspectOptions): Promise<SyncObservation>;
    ...
    resolveConflict(repositoryPath: string, path: string, resolution: "ours" | "theirs"): Promise<void>;
    continueConflict(repositoryPath: string, binding: ProjectBinding, mergeTargetOid: Oid, expectedRemoteOid: Oid): Promise<void>;
