...
async function existingConfig(startPath) {
...
export class FileBindingStore {
    async read(repositoryPath) {
        ...
        try {
            ...
            return projectBindingSchema.parse(raw);
        }
        catch (error) {
            throw new OverleafyError("BINDING_INVALID", `Invalid binding configuration at ${configPath}.`, {
    ...
    async write(repositoryPath, binding) {
